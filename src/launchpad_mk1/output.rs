...
impl PaletteColor {
    pub const BLACK: PaletteColor = Self { id: 4 };
    pub const LO_RED: PaletteColor = Self { id: 1 + 4 };
    pub const HI_RED: PaletteColor = Self { id: 3 + 4 };
    pub const LO_GREEN: PaletteColor = Self { id: 16 + 4 };
    pub const HI_GREEN: PaletteColor = Self { id: 48 + 4 };
    pub const LO_AMBER: PaletteColor = Self { id: 17 + 4 };
    pub const HI_AMBER: PaletteColor = Self { id: 51 + 4 };
    pub const HI_ORANGE: PaletteColor = Self { id: 35 + 4 };
    pub const LO_ORANGE: PaletteColor = Self { id: 18 + 4 };
    pub const HI_YELLOW: PaletteColor = Self { id: 50 + 4 };
    pub const LO_YELLOW: PaletteColor = Self { id: 33 + 4 };
}
...
impl crate::OutputDevice for Output {
    const MIDI_DEVICE_KEYWORD: &'static str = "Launchpad MIDI 1";
...
impl Output {
    ...
    pub fn test_api(&mut self) -> Result<(), crate::MidiError> {
        for x in 0..8 {
            for y in 0..8 {
                self.light(Button::GridButton { x: x, y: y }, PaletteColor::LO_GREEN)?;
